        ...
        {visibleMain.map((item) => {
          ...
          return (
            <Link
              ...
              className={cn(
                "flex min-h-11 cursor-pointer items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-semibold transition-colors duration-200 [&>svg]:size-5",
                active
                  ? "bg-primary text-primary-foreground shadow-[inset_3px_0_0_#000]"
...
export function AppShell({
  ...
  return (
    <div className="min-h-dvh bg-background">
      <aside className="racing-grid fixed inset-y-0 left-0 hidden w-72 border-r bg-card p-5 lg:flex lg:flex-col">
        <BrandMark />
      ...
      <div className="lg:pl-72">
        <header className="sticky top-0 z-30 flex h-[4.5rem] items-center justify-between border-b bg-background/95 px-4 backdrop-blur md:px-6 lg:px-8">
        ...
        <main id="main-content" className="page-enter p-4 md:p-6 lg:p-8">
